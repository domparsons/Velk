...
extension ViewModel {
    ...
    func addNote(folder: Folder, fromClipboard: Bool) {
        ...
        newNote.language = newLanguage.rawValue
    ...
    func updateNote() {
        selectedNote?.name = updatedTitle
        selectedNote?.codeDescription = updatedDescription
    }
    
    func updateCoreDataLanguage() {
        selectedNote?.language = selectedLanguage.rawValue
